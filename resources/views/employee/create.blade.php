            ...
            <div class="card card-primary">
              ...
              @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ old('name')}}" id="exampleInputEmail1" placeholder="Enter name" name="name">
                        @error('name')
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" value="{{ old('email')}}" id="exampleInputEmail1" placeholder="Enter email" name="email">
                    @error('email')
                        <span id="full_name-error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                    @enderror
                  </div>
