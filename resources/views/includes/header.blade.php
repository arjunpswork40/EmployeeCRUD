    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user-menu">
            <a href="javascript:;" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <img src="{{ asset('bower_components/admin-lte/dist/img/avatar04.png')}}" class="user-image img-circle elevation-2" alt="Test">
                <span class="d-none d-md-inline">Test</span>
            </a>
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <!-- User image -->
                <li class="user-header bg-primary">
                    <img src="{{ asset('bower_components/admin-lte/dist/img/avatar04.png')}}" class="img-circle elevation-2" alt="Test">
